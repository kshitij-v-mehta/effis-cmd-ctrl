...
import time
from effis.api import effis_init, effis_check
...
def main():
    try:
        ...
        if rank == 0:
            ...
            effis_init(app_name = os.path.basename(sys.argv[0]), checkpoint, cleanup)
            ...
            for t in range(nt):
                ...
                effis_check(checkpoint_args = (checkpoint_engine, v2, icheckpoint, t), cleanup_args = (writer, checkpoint_writer))
